...
export const acceptInvite = async (inviteId: string) => {
    const response = await axios.post(`/api/accept-trip`, { code: inviteId });
    return response;
}
...
export const getNickname = async () => {
    const response = await axios.get(`/api/view-nickname`);
    return response;
}

export const changeNickname = async (nickname: string) => {
    const response = await axios.post(`/api/change-nickname`, { nickname: nickname });
    return response;
}